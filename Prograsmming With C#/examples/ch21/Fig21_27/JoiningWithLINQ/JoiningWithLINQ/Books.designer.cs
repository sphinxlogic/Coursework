...
namespace JoiningWithLINQ
{
    ...
    partial void DeleteTitle(Title instance);
		...
		public BooksDataContext() : 
				base(global::JoiningWithLINQ.Properties.Settings.Default.BooksConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnISBNChanged();
		...
		[Association(Name="Title_AuthorISBN", Storage="_Title", ThisKey="ISBN", IsForeignKey=true)]
		public Title Title
		{
			get
			{
    ...
    partial void OnCopyrightChanged();
		...
		[Column(Storage="_BookTitle", DbType="VarChar(100) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="Title_AuthorISBN", Storage="_AuthorISBNs", OtherKey="ISBN")]
		public EntitySet<AuthorISBN> AuthorISBNs
		{
			get
			{
