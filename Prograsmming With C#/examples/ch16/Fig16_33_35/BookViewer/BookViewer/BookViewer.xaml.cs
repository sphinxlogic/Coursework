...
namespace BookViewer
{
   public partial class BookViewerWindow : Window
   {
      ...
      public BookViewerWindow()
      {
         ...
         books.Add( new Book( "AJAX, Rich Internet Applications, and Web " +
            "Development for Programmers", "0131587382",
         ...
         books.Add( new Book( "Internet and World Wide Web How to Program",
            "0131752421", "images/small/iw3htp4.jpg",
            "images/large/iw3htp4.jpg" ) );
