// Fig. 24.11: FlickrViewer.xaml.cs
...
{
   public partial class FlickrViewerPage : UserControl
   {
      // Flickr API key
      private const string KEY = "Your API key goes here as string";

      // object used to invoke Flickr web service
      private WebClient flickr = new WebClient();

      // constructor
      public FlickrViewerPage()
      {
         InitializeComponent();
         flickr.DownloadStringCompleted += new
